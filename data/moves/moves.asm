...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move MEGA_PUNCH,   EFFECT_NORMAL_HIT,        100, FIGHTING,      85, 10,   0
	...
	move RAZOR_WIND,   EFFECT_RAZOR_WIND,         80, FLYING,        95, 15,   0
	move SWORDS_DANCE, EFFECT_ATTACK_UP_2,         0, NORMAL,       100, 30,   0
	move CUT,          EFFECT_NORMAL_HIT,         65, FLYING,        95, 30,   0
	...
	move FLY,          EFFECT_CONFUSE,             0, FLYING,       100, 25,   0
	move BIND,         EFFECT_TRAP_TARGET,        15, NORMAL,        85, 20,   0
	move SLAM,         EFFECT_DEFENSE_DOWN_HIT,   80, NORMAL,       100, 20,  30
	...
	move MEGA_KICK,    EFFECT_HYPER_BEAM,        150, FIGHTING,      85,  5,   0
	...
	move HORN_ATTACK,  EFFECT_NORMAL_HIT,         75, NORMAL,       100, 25,   0
	...
	move THRASH,       EFFECT_RAMPAGE,           100, NORMAL,       100, 20,   0
	...
	move SUPERSONIC,   EFFECT_CONFUSE,             0, FLYING,        70, 20,   0
	move SONICBOOM,    EFFECT_STATIC_DAMAGE,      20, FLYING,       100, 20,   0
	move DISABLE,      EFFECT_DISABLE,             0, NORMAL,        75, 20,   0
	move ACID,         EFFECT_DEFENSE_DOWN_HIT,   40, POISON,       100, 30,  50
	move EMBER,        EFFECT_BURN_HIT,           40, FIRE,         100, 25,  10
	move FLAMETHROWER, EFFECT_BURN_HIT,           95, FIRE,         100, 15,  30
	...
	move DRILL_PECK,   EFFECT_NORMAL_HIT,         90, FLYING,       100, 20,   0
	...
	move FIRE_SPIN,    EFFECT_TRAP_TARGET,        55, FIRE,         100, 15,   0
	...
	move RAGE,         EFFECT_RAGE,               40, NORMAL,       100, 20,   0
	...
	move SKULL_BASH,   EFFECT_SKULL_BASH,        100, STEEL,        100, 15,   0
	...
	move SOFTBOILED,   EFFECT_HEAL,                0, NORMAL,       100, 20,   0
	...
	move FLASH,        EFFECT_DISABLE,             0, NORMAL,       100, 20,   0
	...
	move SLASH,        EFFECT_NORMAL_HIT,         75, NORMAL,       100, 20,   0
	...
	move FLAME_WHEEL,  EFFECT_FLAME_WHEEL,        65, FIRE,         100, 25,  30
	...
	move DETECT,       EFFECT_HEAL,                0, FIGHTING,     100,  5,   0
	...
	move FURY_CUTTER,  EFFECT_FURY_CUTTER,        30, BUG,           95, 20,   0
	move STEEL_WING,   EFFECT_DEFENSE_UP_HIT,     75, STEEL,        100, 25,  10
	...
	move RETURN,       EFFECT_RETURN,              1, NORMAL,       100, 10,   0
	move PRESENT,      EFFECT_PRESENT,             1, NORMAL,        90, 15,   0
	move FRUSTRATION,  EFFECT_NORMAL_HIT,         90, DARK,         100, 20,   0
	...
	move DYNAMICPUNCH, EFFECT_CONFUSE_HIT,       100, FIGHTING,      70, 10, 100
	...
	move RAPID_SPIN,   EFFECT_RAPID_SPIN,         60, NORMAL,       100, 40,   0
	...
	move WHIRLPOOL,    EFFECT_TRAP_TARGET,        35, DRAGON,       100, 15,   0
